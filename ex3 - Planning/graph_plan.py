...
def independent_pair(a1, a2):
    ...
    # inconsistent effect
    a = [added for added in a1.get_add() if added in a2.get_delete()]
    b = [added for added in a2.get_add() if added in a1.get_delete()]

    # interference
    c = [pre for pre in a1.get_delete() if a2.is_pre_cond(pre)]
    d = [pre for pre in a2.get_delete() if a1.is_pre_cond(pre)]
